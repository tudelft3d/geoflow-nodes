...
int main(int ac, const char * av[])
{
    ...
    std::strcpy(ogr_loader_1->filepath, "/Users/ravi/surfdrive/Data/step-edge-detector/small-test/3bg_v01_hoogtelijnen_.gpkg");
    auto ogr_loader_2 = std::make_shared<OGRLoaderNode>(N);
    std::strcpy(ogr_loader_2->filepath, "/Users/ravi/surfdrive/Data/step-edge-detector/small-test/dgmr_hoogtelijnen_.gpkg");
    ...
    std::strcpy(comp_dist->las_filepath, "/Users/ravi/surfdrive/data/step-edge-detector/C_31HZ1_clip.LAZ");
